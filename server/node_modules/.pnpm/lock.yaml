...
importers:
  ...
  .:
    dependencies:
      ...
      mongodb:
        specifier: ^6.14.0
        version: 6.14.0(socks@2.8.4)
      mongoose:
        specifier: ^8.11.0
        version: 8.11.0(socks@2.8.4)
      mysql2:
        specifier: ^3.12.0
        version: 3.12.0
      nodemailer:
...
packages:
  ...
  mongodb@6.14.0:
    resolution: {integrity: sha512-AlM6alTx98vcnk/jMMmoYuBrm4qpe1/VrbwvL2SXEHjdtJ1ZbVZmrpyjUx9mqS94e9HcemzpLn+CxzhmT7b0uw==}
    engines: {node: '>=16.20.1'}
    peerDependencies:
  ...
  mongoose@8.11.0:
    resolution: {integrity: sha512-xaQSuaLk2JKmXI5zDVVWXVCQTnWhAe8MFOijMnwOuP/wucKVphd3f+ouDKivCDMGjYBDrR7dtoyV0U093xbKqA==}
    engines: {node: '>=16.20.1'}
