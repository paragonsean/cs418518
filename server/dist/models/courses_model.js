        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _connectdb["default"].execute("SELECT * FROM courses");
            case 3:
              _yield$pool$execute = _context.sent;
              _yield$pool$execute2 = _slicedToArray(_yield$pool$execute, 1);
              rows = _yield$pool$execute2[0];
              _my_logger["default"].info(" Retrieved all courses from the database.");
              return _context.abrupt("return", rows);
            case 10:
              _context.prev = 10;
              _context.t0 = _context["catch"](0);
              _my_logger["default"].error(" Error retrieving courses: ".concat(_context.t0.message));
              throw _context.t0;
            case 14:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _connectdb["default"].execute("SELECT * FROM courses WHERE course_level = ?", [level]);
            case 3:
              ...
              _my_logger["default"].warn("Course not found for level: ".concat(level));
              return _context2.abrupt("return", null);
            case 9:
              _my_logger["default"].info(" Course found for level: ".concat(level));
              return _context2.abrupt("return", rows[0]);
            case 13:
              _context2.prev = 13;
              _context2.t0 = _context2["catch"](0);
              _my_logger["default"].error(" Error retrieving course for level ".concat(level, ": ").concat(_context2.t0.message));
              throw _context2.t0;
            case 17:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _connectdb["default"].execute("UPDATE courses SET course_name=? WHERE course_level=?", [courseName, level]);
            case 3:
              ...
              _my_logger["default"].warn("Course not found for update: ".concat(level));
              return _context3.abrupt("return", false);
            case 9:
              _my_logger["default"].info(" Course name updated for level: ".concat(level));
              return _context3.abrupt("return", true);
            case 13:
              _context3.prev = 13;
              _context3.t0 = _context3["catch"](0);
              _my_logger["default"].error(" Error updating course name for level ".concat(level, ": ").concat(_context3.t0.message));
              throw _context3.t0;
            case 17:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return _connectdb["default"].execute("UPDATE courses SET prerequisite=? WHERE course_level=?", [prerequisite, level]);
            case 3:
              ...
              _my_logger["default"].warn("Course not found for prerequisite update: ".concat(level));
              return _context4.abrupt("return", false);
            case 9:
              _my_logger["default"].info(" Prerequisite updated for level: ".concat(level));
              return _context4.abrupt("return", true);
            case 13:
              _context4.prev = 13;
              _context4.t0 = _context4["catch"](0);
              _my_logger["default"].error(" Error updating prerequisite for level ".concat(level, ": ").concat(_context4.t0.message));
              throw _context4.t0;
            case 17:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _my_logger["default"].warn("Missing required fields when adding a course.");
              throw new Error("Missing required fields");
            case 4:
              _context5.prev = 4;
              _context5.next = 7;
              return _connectdb["default"].execute("INSERT INTO courses (course_name, course_level, prerequisite, course_lvlGroup) VALUES (?, ?, ?, ?)", [course_name, course_level, prerequisite, course_lvlGroup]);
            case 7:
              ...
              _my_logger["default"].info(" New course added: ".concat(course_name, " (Level: ").concat(course_level, ")"));
            ...
            case 14:
              ...
              _my_logger["default"].error(" Error inserting course (".concat(course_name, "): ").concat(_context5.t0.message));
              throw _context5.t0;
            case 18:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.prev = 0;
              _context6.next = 3;
              return _connectdb["default"].execute("DELETE FROM courses WHERE course_level=?", [level]);
            case 3:
              ...
              _my_logger["default"].warn("Course not found for deletion: ".concat(level));
              return _context6.abrupt("return", false);
            case 9:
              _my_logger["default"].info(" Course deleted: Level ".concat(level));
              return _context6.abrupt("return", true);
            case 13:
              _context6.prev = 13;
              _context6.t0 = _context6["catch"](0);
              _my_logger["default"].error(" Error deleting course for level ".concat(level, ": ").concat(_context6.t0.message));
              throw _context6.t0;
            case 17:
            case "end":
...
var _default = exports["default"] = CoursesModel;