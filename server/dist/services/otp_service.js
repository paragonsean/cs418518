...
var _my_logger = _interopRequireDefault(require("./my_logger.js"));
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          mailOptions = {
            ...
            text: "Your One-Time Password (OTP) is: ".concat(otp, ". It is valid for 10 minutes.")
          };
          _context.prev = 2;
          _context.next = 5;
          return transporter.sendMail(mailOptions);
        case 5:
          _my_logger["default"].info("\uD83D\uDCE9 OTP sent successfully to ".concat(email)); //  Log success
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](2);
          _my_logger["default"].error(" Error sending OTP email to ".concat(email, ": ").concat(_context.t0.message)); //  Log error
        case 11:
        case "end":
