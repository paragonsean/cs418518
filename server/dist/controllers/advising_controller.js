...
class AdvisingController {
  ...
  static async getAdvisingRecordsByEmail(req, res) {
    try {
      var _req$user;
      const email = (_req$user = req.user) === null || _req$user === void 0 ? void 0 : _req$user.email;
      if (!email) {
  ...
  static async createAdvisingRecord(req, res) {
    try {
      ...
      const student_email = (_req$user2 = req.user) === null || _req$user2 === void 0 ? void 0 : _req$user2.email;
      if (!student_email) {
