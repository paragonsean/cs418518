...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // Import pool connection
// Import logger
      ...
      var _getAllCourses = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 8:
              _my_logger["default"].info("Retrieved all courses from the pool.");
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 13:
              ...
              _my_logger["default"].error(" Error retrieving course for level ".concat(req.params.level, ": ").concat(_context2.t0.message));
              res.status(500).json({
                status: 500,
                message: "Internal Server Error"
              });
      ...
      var _updateCourseName = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 5:
              _context3.next = 7;
              return _connectdb["default"].execute("UPDATE courses SET course_name = ? WHERE course_level = ?", [course_name, level]);
            case 7:
            ...
            case 16:
              ...
              _my_logger["default"].error(" Error updating course name: ".concat(_context3.t0.message));
              res.status(500).json({
                status: 500,
                message: "Internal Server Error"
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 16:
              ...
              _my_logger["default"].error(" Error updating prerequisite: ".concat(_context4.t0.message));
              res.status(500).json({
                status: 500,
                message: "Internal Server Error"
              });
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 13:
              ...
              _my_logger["default"].error(" Error adding course: ".concat(_context5.t0.message));
              res.status(500).json({
                status: 500,
                message: "pool error"
              });
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 13:
              ...
              _my_logger["default"].error(" Error deleting course: ".concat(_context6.t0.message));
              res.status(500).json({
                status: 500,
                message: "Internal Server Error"
              });
...
var _default = exports["default"] = CourseController;