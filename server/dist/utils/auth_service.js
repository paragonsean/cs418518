 ...
 */
export var hashPassword = /*#__PURE__*/function () {
 ...
 */
export var comparePassword = /*#__PURE__*/function () {
 ...
 */
export var generateToken = function generateToken(user) {
  return jwt.sign({
 ...
 */
export var verifyToken = function verifyToken(token) {
  try {
