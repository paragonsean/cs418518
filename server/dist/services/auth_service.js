...
exports.verifyToken = exports.hashPassword = exports.generateToken = exports.comparePassword = void 0;
 ...
 */
var comparePassword = exports.comparePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(enteredPassword, storedPassword) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          _context2.next = 4;
          return _bcrypt["default"].compare(enteredPassword, storedPassword);
        case 4:
...
var verifyToken = exports.verifyToken = function verifyToken(token) {
  try {
    return _jsonwebtoken["default"].verify(token, process.env.TOKEN_SECRET_KEY);
  } catch (error) {
